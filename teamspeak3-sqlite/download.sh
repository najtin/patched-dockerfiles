#!/bin/bash
set -e
(ulimit -f 2000; curl https://www.teamspeak.com/en/downloads/ --output /home/ts3server/download/site)
...
(ulimit -f 12000; curl "$(cat /home/ts3server/download/url)" --output /home/ts3server/download/teamspeak3-server_linux_amd64.tar.bz2)
